/**
 * Page principale du menu Paramètres pour les propriétaires
 *
 * Permet d'accéder à tous les paramètres du propriétaire:
...
export default function OwnerSettingsMenuPage() {
      ...
      items: [
        {
          ...
          icon: User,
          onClick: () => navigate('/proprietaire/profil'),
        },
        {
          id: 'security',
          label: 'Sécurité',
          ...
          icon: Shield,
          onClick: () => navigate('/proprietaire/parametres/securite'),
        },
        {
          id: 'sessions',
          label: 'Sessions',
          ...
          icon: Globe,
          onClick: () => navigate('/proprietaire/parametres/sessions'),
        },
      ],
    },
    {
      ...
      items: [
        {
          ...
          icon: Bell,
          onClick: () => navigate('/proprietaire/parametres/notifications'),
        },
        {
    ...
    <div className="min-h-[75vh] bg-[#FAF7F4] px-2 sm:px-4 pb-4 pt-6 lg:pt-2">
      ...
      <div className="mt-8 text-center">
        <p className="text-xs text-[#8B7466]">
          Version de l\'application - Espace Propriétaire
        </p>
      </div>
    </div>
  );
