...
export default function PaymentsPage() {
  ...
  const calculateStats = (contractsData: ContractWithPayments[]) => {
    ...
    contractsData.forEach((contract) => {
      // Current month rent (based on contract, not on payments)
    ...
    // Calculate payment rate based on actual paid vs expected for current month
        ...
        <div className="w-full px-4 sm:px-6 lg:px-8 xl:px-12 py-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-[#E8D4C5]">Suivez vos loyers et gérez les charges locatives</p>
            </div>
          </div>
        </div>
      </div>
