/**
 * Page de sécurité pour les agences
 *
 * Permet de gérer:
...
export default function AgencySecuritySettingsPage() {
      ...
      <div className="mb-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-[#8B7466] mt-1">Gérez la sécurité de votre compte agence</p>
          </div>
        </div>
      </div>
