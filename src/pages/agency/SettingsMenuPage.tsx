/**
 * Page principale du menu Paramètres pour les agences
 *
 * Permet d'accéder à tous les paramètres de l'agence:
...
export default function AgencySettingsMenuPage() {
      ...
      items: [
        {
          ...
          description: 'Nom, logo, informations de contact',
          icon: User,
          onClick: () => navigate('/agences/profil'),
        },
        {
          id: 'security',
          label: 'Sécurité',
          ...
          icon: Shield,
          onClick: () => navigate('/agences/parametres/securite'),
        },
        {
          id: 'sessions',
          label: 'Sessions',
          ...
          icon: Globe,
          onClick: () => navigate('/agences/parametres/sessions'),
        },
      ],
    },
    {
      ...
      items: [
        {
          ...
          icon: Bell,
          onClick: () => navigate('/agences/parametres/notifications'),
        },
        {
          ...
          icon: Bell,
          onClick: () => navigate('/agences/notifications'),
        },
      ],
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          icon: Bug,
          onClick: () => navigate('/contact?category=technical&bug=true'),
        },
      ],
    },
    {
    ...
    <div className="min-h-[75vh] bg-[#FAF7F4] px-2 sm:px-4 pb-4 pt-6 lg:pt-2">
      ...
      <div className="mt-8 text-center">
        <p className="text-xs text-[#8B7466]">
          Version de l'application - Agence Immobilière
        </p>
      </div>
    </div>
  );
