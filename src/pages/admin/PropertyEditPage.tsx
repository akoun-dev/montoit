    ...
    return (
      <div className="min-h-screen bg-[#FAF7F4] flex items-center justify-center">
        <div className="text-center">
          <Loader2 className="w-12 h-12 animate-spin text-[#F16522] mx-auto mb-4" />
          <p className="text-[#6B5A4E]">Chargement de la propriété...</p>
        </div>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-[#FAF7F4] p-6">
      <div className="w-full max-w-4xl mx-auto">
        ...
        <div className="mb-6">
          ...
          <h1 className="text-3xl font-bold text-[#2C1810]">Modifier la propriété</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          {/* Publication & Options */}
          <div className="bg-white rounded-2xl border border-[#EFEBE9] p-6">
            <h2 className="text-xl font-semibold text-[#2C1810] mb-4">Publication & Options</h2>
              ...
              <div className="space-y-2">
                <label className="flex items-center gap-2 cursor-pointer">
                  <input
                    ...
                    className="w-5 h-5 rounded border-[#EFEBE9] text-[#F16522] focus:ring-[#F16522]"
                  />
                  <span className="text-sm font-medium text-[#2C1810]">Publiée (visible par les utilisateurs)</span>
                </label>
                ...
                <label className="flex items-center gap-2 cursor-pointer">
                  <input
                    ...
                    className="w-5 h-5 rounded border-[#EFEBE9] text-[#F16522] focus:ring-[#F16522]"
                  />
                  <span className="text-sm font-medium text-[#2C1810]">Propriété vedette (mise en avant)</span>
                </label>
                ...
                <label className="flex items-center gap-2 cursor-pointer">
                  <input
                    ...
                    className="w-5 h-5 rounded border-[#EFEBE9] text-[#F16522] focus:ring-[#F16522]"
                  />
                  <span className="text-sm font-medium text-[#2C1810]">Vérifiée ANSUT</span>
                </label>
              </div>
            </div>
          </div>
