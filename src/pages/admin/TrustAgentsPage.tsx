      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-white rounded-2xl border border-[#EFEBE9] p-8 text-center">
          ...
          <p className="text-[#6B5A4E] max-w-lg mx-auto">
            Cette page est un placeholder. Le contenu et les fonctionnalités des Agents de confiance sont en cours de développement. Revenez bientôt pour une expérience complète.
          </p>
          <button
