  ...
  return (
    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="space-y-6">
      <div>
        ...
        <p className="text-neutral-500 mt-1">Configuration de la plateforme Mon Toit</p>
      </div>
      ...
      <Card className="border-neutral-200">
        ...
        <CardContent className="space-y-4">
          <div className="flex items-center justify-between p-3 rounded-lg border border-neutral-200">
            <div>
              <p className="text-sm font-medium text-neutral-900">OTP obligatoire</p>
              <p className="text-xs text-neutral-500">Exiger un code OTP pour chaque connexion</p>
            </div>
            <Switch defaultChecked />
          </div>
          <div className="flex items-center justify-between p-3 rounded-lg border border-neutral-200">
            <div>
              <p className="text-sm font-medium text-neutral-900">Expiration OTP (minutes)</p>
              <p className="text-xs text-neutral-500">Durée de validité du code OTP</p>
            </div>
      ...
      <Card className="border-neutral-200">
        ...
        <CardContent className="space-y-4">
          <div className="flex items-center justify-between p-3 rounded-lg border border-neutral-200">
            <div>
              <p className="text-sm font-medium text-neutral-900">Notifications email</p>
              <p className="text-xs text-neutral-500">Envoyer des alertes par email</p>
            </div>
            <Switch defaultChecked />
          </div>
          <div className="flex items-center justify-between p-3 rounded-lg border border-neutral-200">
            <div>
              <p className="text-sm font-medium text-neutral-900">Notifications SMS</p>
              <p className="text-xs text-neutral-500">Envoyer des alertes par SMS</p>
            </div>
            <Switch />
          </div>
        </CardContent>
