...
export default function ReviewResponseModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
      <div className="bg-white rounded-2xl max-w-lg w-full mx-auto max-h-[90vh] overflow-y-auto shadow-2xl">
        {/* Header */}
        <div className="flex items-center justify-between p-4 md:p-6 border-b border-[#EFEBE9]">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl bg-[#F16522] flex items-center justify-center">
              <MessageSquare className="h-5 w-5 text-white" />
            </div>
            <div>
              <h2 className="text-lg md:text-xl font-bold text-[#2C1810]">
                {existingResponse ? 'Modifier votre réponse' : "Répondre à l'avis"}
              </h2>
              <p className="text-xs md:text-sm text-[#6B5A4E]">
          ...
          <button
            onClick={onClose}
            className="p-1.5 hover:bg-[#FAF7F4] rounded-xl transition-colors"
          >
        ...
        <div className="p-4 md:p-6 space-y-4">
          ...
          <div className="bg-[#FAF7F4] rounded-xl p-4 border border-[#EFEBE9]">
            <p className="text-xs font-semibold text-[#2C1810] mb-2">
        ...
        {/* Footer */}
        <div className="p-4 md:p-6 border-t border-[#EFEBE9] flex flex-col sm:flex-row justify-end gap-2 sm:gap-3">
