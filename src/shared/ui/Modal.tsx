...
export function RoleSwitchModal({
  ...
  const roleConfig: Record<
    string,
    { label: string; icon: unknown; color: string; description: string }
  > = {
    tenant: {
      label: 'Locataire',
      icon: Key,
      color: 'blue',
      description:
        'Vous pourrez rechercher des biens, postuler des candidatures, gérer vos contrats de location et vos paiements.',
    },
    owner: {
      label: 'Propriétaire',
      icon: Home,
      color: 'orange',
      description:
        'Vous pourrez gérer vos biens immobiliers, publier des annonces, gérer les contrats et les locataires.',
    },
    agency: {
      label: 'Agence',
      icon: Building2,
      color: 'purple',
      description:
        'Vous pourrez gérer les biens de vos clients, gérer les mandats et les contrats au nom des propriétaires.',
    },
  };
    ...
    >
      <div className="space-y-4">
        ...
        <div className="flex justify-center">
          <div
            className={`w-12 h-12 rounded-full bg-${to.color}-100 flex items-center justify-center`}
          >
        ...
        {/* Nouveau rôle */}
        <div
          className={`flex items-center gap-4 p-4 bg-${to.color}-50 border-2 border-${to.color}-200 rounded-xl`}
        >
