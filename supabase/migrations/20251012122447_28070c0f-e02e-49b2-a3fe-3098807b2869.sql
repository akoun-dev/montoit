-- Améliorer get_public_properties pour recherche insensible à la casse
DROP FUNCTION IF EXISTS get_public_properties(text, text, numeric, numeric, integer, text);
