-- ============================================
-- PHASE 2: Restreindre l'accès direct à la table profiles (correctif)
-- ============================================
...
-- 2. Supprimer les anciennes policies si elles existent pour les recréer
...
-- 3. Créer une policy pour que les utilisateurs voient leur propre profil complet
...
-- 4. Créer une policy pour que les propriétaires voient les profils de leurs candidats
...
-- 5. Créer une policy pour que les candidats voient les profils des propriétaires
...
-- 6. Créer une policy pour que les parties d'un bail se voient mutuellement
...
-- 7. Créer une policy pour que les admins voient tous les profils
